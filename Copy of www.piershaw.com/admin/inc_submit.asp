...
If (CStr(UploadFormRequest("MM_insert")) = "add_data") Then
  ...
  End If
  MM_fieldsStr  = "TYPE|value|NAME|value|URL|value|PICTURE|value|LOCATION|value|BRAND|value|NUMBER|value|DATED|value|EXPIRED|value|QUANTITY|value|PRICE|value|SHIP|value|DESCRIPTION|value|USER|value|APPROVED|value"
