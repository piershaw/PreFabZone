                            ...
                            <td align="left" valign="top" class="text" colspan="2"> 
                              <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                <tr > 
                                  ...
                                  <td align="right" valign="middle" class="textBold"><a href="../home/channel.asp?iChannel=<%=(rsNewChannels.Fields.Item("CHA_ID").Value)%>&nChannel=<%=(rsNewChannels.Fields.Item("CHA_NAME").Value)%>">---&raquo;</a></td>
                                </tr>
                                <tr> 
                                  ...
                                  <td colspan="2"> <table width="100%" border="0" cellspacing="2" cellpadding="2">
                                      <tr> 
                                        <td align="left" valign="top" class="text">&raquo; <%=(rsNewDatas.Fields.Item("DAT_DATED").Value)%>: 
                                          <a href="../home/detail.asp?iData=<%=(rsNewDatas.Fields.Item("DAT_ID").Value)%>&iCat=<%=(rsNewDatas.Fields.Item("DAT_CATEGORY").Value)%>&iChannel=<%=(rsNewDatas.Fields.Item("CAT_CHANNEL").Value)%>&nChannel=<%=(rsNewChannels.Fields.Item("CHA_NAME").Value)%>"><% =(DoTrimProperly((rsNewDatas.Fields.Item("DAT_NAME").Value), 50, 1, 1, " ...")) %></a></td>
                                      </tr>
                                    </table></td>
                                </tr>
                                <% 
